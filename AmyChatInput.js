...
class AmyChatInput extends Component {
    state = {
        messageStatus:"",
        username:""
    }
    ...
    handleSubmit = event => {
       ...
       // this.setState({username: this.props.currentChat[0].username});
        this.props.addMessage(this.props.currentChat[0].username, this.state.messageStatus);
    }
